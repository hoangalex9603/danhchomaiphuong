...
$('document').ready(function(){
	...
	// show/hide surprise overlay (image or video)
	function showSurprise(){
		$('#surprise-img').hide();
		$('#surprise-video').hide();
		$('#surprise-overlay').removeClass('hidden').hide().fadeIn('fast');
		var video = document.getElementById('surprise-video');
		var videoSrc = $('#surprise-video source').attr('src');
		...
		$('#surprise-close').off('click').on('click', hideSurprise);
		$('#surprise-overlay').off('click').on('click', function(e){ if(e.target.id==='surprise-overlay') hideSurprise(); });
	}
	function hideSurprise(){
		var video = document.getElementById('surprise-video');
		try{ video.pause(); video.currentTime = 0; }catch(e){}
		$('#surprise-overlay').fadeOut('fast', function(){ $(this).addClass('hidden'); });
	}
});
